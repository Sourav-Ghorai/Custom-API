...
app.patch("/jokes/:id", (req, res) => {
   ...
   // else text = joke.jokeText
   // if(req.body.type) type = req.body.type;
   // else type = joke.jokeType
   // const modifiedJoke = {
   //    id: id,
   //    jokeText: text,
   //    jokeType: type,
...
app.delete("/jokes/:id", (req, res)=>{
   ...
   if(id>-1 && id<jokes.length){
      ...
      res.status(404).json({error: `response with id ${id} not found, no item deleted.`})
   }
})
